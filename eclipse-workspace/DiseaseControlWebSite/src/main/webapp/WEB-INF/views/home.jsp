...
&nbsp;&nbsp;${id}님 환영합니다.&nbsp;<input type="button" value="로그아웃" onclick="location='logOut'"> 
...
　<input type="button" style="background-color:white; border-color:white; border-radius:10px; color:#5F9EA0; font-weight:bold; font-size:15px; padding:10px 7px;" 
	value="자기기입식 조사서" onclick="location='selfReport'">
　<input type="button" style="background-color:white; border-color:white; border-radius:10px; color:#5F9EA0; font-weight:bold; font-size:15px; padding:10px 7px;" 
	value="게시판" onclick="location='noticeBoard?page=1'">
<br><br>
